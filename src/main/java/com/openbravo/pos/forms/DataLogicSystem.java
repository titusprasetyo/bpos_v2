...
//    private final byte[] getResource(String name) {
    ...
    * @return
    */
   public final String getResourceAsXMLd(String sName) {
	 //[ENC TITUS] ==> getXMLResource direct from file
   	...
   	try{
   		String sCurrentLine="";
   		in = getClass().getResourceAsStream("/com/openbravo/pos/templates/"+sName+".xml"); 
