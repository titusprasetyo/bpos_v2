        ...
        try {
            ...
            if (products.length > 0){
                ...
                for (Product product : products) {
                    ...
                    CategoryInfo c = new CategoryInfo(product.getCategory().getId(), product.getCategory().getName(), null, "", false);
                    dlintegration.syncCategory(c);

                    // Synchonization of products
                    ProductInfoExt p = new ProductInfoExt();
                    p.setID(product.getId());
                    p.setReference(product.getNumber());
            ...
            if (customers.length > 0 ) {
                ...
                for (Customer customer : customers) {                    
                    ...
                    cinfo.setAddress(customer.getLocations()[0].getAddress1());
                    cinfo.setAddress2(customer.getLocations()[0].getAddress2());
                    cinfo.setCity(customer.getLocations()[0].getCity());
                    cinfo.setCountry(customer.getLocations()[0].getCountry());
                    cinfo.setEmail(customer.getContacts()[0].getEmail());
                    cinfo.setFax(customer.getContacts()[0].getFax());
                    cinfo.setFirstname(customer.getContacts()[0].getFirstName());
                    cinfo.setLastname(customer.getContacts()[0].getLastName());
                    cinfo.setPhone(customer.getContacts()[0].getPhone());
                    cinfo.setPhone2(customer.getContacts()[0].getPhone2());
                    cinfo.setPostal(customer.getLocations()[0].getPostal());
                    cinfo.setRegion(customer.getLocations()[0].getRegion());
